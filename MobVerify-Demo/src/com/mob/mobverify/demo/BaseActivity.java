...
public abstract class BaseActivity extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ViewGroup container = (ViewGroup) inflater.inflate(R.layout.mob_verify_demo_container, null);
...
//			decorView.setSystemUiVisibility(option);
	...
	private void initView() {
		...
		leftTv = findViewById(R.id.mob_verify_demo_title_bar_left);
		leftTv.setOnClickListener(this);
		rightIv = findViewById(R.id.mob_verify_demo_title_bar_right);
		rightIv.setOnClickListener(this);
		centerTv = findViewById(R.id.mob_verify_demo_title_bar_center);
		if (titleStyle != null) {
